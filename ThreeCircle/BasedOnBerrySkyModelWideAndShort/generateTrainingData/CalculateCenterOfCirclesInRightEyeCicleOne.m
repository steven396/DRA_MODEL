function [point_x_right,point_y_right]=CalculateCenterOfCirclesInRightEyeCicleOne(numberOfHalfEyes)
k1 = 1/2;
k2 = sqrt(3)/4;
rate = 1/3;

p1_x_right=0;
p1_y_right=-1*k2*rate;
p2_x_right=k1*(1-rate);
p2_y_right=-1*k2;
p3_x_right=0;
p3_y_right=-1*(k2+2*k2*rate);
