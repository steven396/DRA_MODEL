function [MatrixOfDegree,MatrixOfIntensity]=DegreeForEveryPhotoreceptorsForRayleigh(phi_sun,theta_sun,headDirection,numberOfHalfEyes,T)
...
[x,y,z,delta,Intensity] = RayleighModel(phi_sun,theta_sun,T);
% delta=delta*1.2;
