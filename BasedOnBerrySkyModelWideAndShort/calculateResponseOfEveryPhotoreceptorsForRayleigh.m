function [response,p1_sum,p2_sum]=calculateResponseOfEveryPhotoreceptorsForRayleigh(phi_sun,theta_sun,headDirection,numberOfHalfEyes,T)
[MatrixOfAngles]=angleBetweenEvectorAndEveryPhotoreceptors(phi_sun,theta_sun,headDirection,numberOfHalfEyes);
[MatrixOfDegree,MatrixOfIntensity]=DegreeForEveryPhotoreceptorsForRayleigh(phi_sun,theta_sun,headDirection,numberOfHalfEyes,T);
