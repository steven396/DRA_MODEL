function [MatrixOfDegree]=DegreeForEveryPhotoreceptorsForRayleigh(phi_sun,theta_sun,headDirection,numberOfHalfEyes)
...
[x,y,z,delta] = RayleighModel(phi_sun,theta_sun);
% delta=delta*1.2;
